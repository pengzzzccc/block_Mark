 ...
 */
export function executeDuel(attacker, defender, targetBlock, duelState) {
    // Both players roll
 ...
 */
export function applyDuelResult(attacker, defender, targetBlock, duelState) {
 ...
 */
export function calculateWager(block) {
