...
const ORDINAL_COLORS: BlockColor[] = ['red', 'yellow', 'blue', 'green'];
const ORDINAL_NUMBERS: OrdinalNumber[] = [1, 2, 3, 4];
 ...
 */
export function initBlockPool(): Block[] {
    const blocks: Block[] = [];
 ...
 */
export function setupOpenMarket(blindPile: Block[]): { openMarket: Block[]; blindPile: Block[] } {
 ...
 */
export function replenishMarket(openMarket: Block[], blindPile: Block[]): { openMarket: Block[]; blindPile: Block[] } {
 ...
 */
export function blindDraw(blindPile: Block[]): { block: Block; blindPile: Block[] } | null {
    if (blindPile.length === 0) return null;
    const block = blindPile.shift()!;
...
export function buyFromMarket(
    ...
    blindPile: Block[],
    blockId: string,
): { block: Block; openMarket: Block[]; blindPile: Block[] } | null {
 ...
 */
export function getBlockCost(block: Block): number {
